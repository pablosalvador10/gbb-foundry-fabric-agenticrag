...
class AzureClientManager:
        ...
        if self.ai_foundry_client is None:
            ...
            if endpoint and api_key and project_name:
                ...
                try:
                    ...
                    print(
                        f"⚠️ Failed to initialize AI Foundry client with DefaultAzureCredential: {e}"
                    )
                    return None
    ...
    def is_ai_foundry_enabled(self) -> bool:
        ...
        return (
            AI_FOUNDRY_AVAILABLE
            and os.getenv("AZURE_AI_FOUNDRY_PROJECT_NAME")
            and os.getenv("AZURE_AI_FOUNDRY_ENDPOINT")
        )
