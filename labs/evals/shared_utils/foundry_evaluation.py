        ...
        try:
            ...
            try:
                ...
                uploaded_dataset = self.foundry_client.datasets.upload_file(
                    name=dataset_name, version="1.0", file_path=temp_file.name
                )
                ...
                if isinstance(results, dict):
                    ...
                    results["_run_name"] = (
                        run_name or f"Lab1 Evaluation - {len(data)} items"
                    )
                    results["_description"] = (
                        description
    ...
    def _run_local_evaluation(
        ...
        try:
            ...
            try:
                ...
                results = evaluate(data=temp_file.name, evaluators=evaluators)
            finally:
                # Restore stdout
