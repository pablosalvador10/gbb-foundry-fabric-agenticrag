...
def build_copilot_agent(name: Optional[str] = None,
                        description: Optional[str] = None) -> CopilotStudioAgent:
...
async def build_foundry_agent(project,
    ...
    if not existing_id:
        ...
        agent = ChatAgent(
            ...
            instructions=instructions or "Answer with metrics/tables and add source hints."
        )
        return agent
    else: 
